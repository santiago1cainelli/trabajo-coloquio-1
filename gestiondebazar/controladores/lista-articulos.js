...
const inputStockreservado = document.querySelector('#stockreservado');
        ...
        listado.innerHTML += `
            <div class="col">
                <div class="card" style="width: 18rem">
                    <img src="./imagenes/productos/${articulo.imagen}" class="card-img-top" alt="./imagenes/productos/${articulo.nombre}" />
                    <div class="card-body">
                        <h5 class="card-title">
                        ...
                        <h5>Stock: <span name="spanstock">${articulo.stock}</span></h5>
                        <h5>Stock reservado: <span name="spanstockreservado">${articulo.stockreservado}</span></h5>
...
btnNuevo.addEventListener('click', () => {
    ...
    inputStock.value = null;
    inputStockreservado.value = null;
...
on(document, 'click', '.btn-editar', e =>{
    ...
    inputStock.value = articulo.stock;
    inputStockreservado.value = articulo.stockreservado;
